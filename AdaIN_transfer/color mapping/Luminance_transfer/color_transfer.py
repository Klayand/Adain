...
class ColorTransfer:
    ...
    def __init__(self, source_path, target_path, clip=True, preserve_paper=True, api=False):
        ...
        if preserve_paper:
            ...
            # scaled by the stanard deviations using reciprocal of paper proposed factor
...
if __name__ == '__main__':
    ...
    source_path = r'style/hosi.jpg'
    tagret_path = r'content/sailboat.jpg'

    source = cv2.imread(source_path)
    target = cv2.imread(tagret_path)

    color_transfer = ColorTransfer(source_path, tagret_path, preserve_paper=False).transfer_image
